...
<%--&lt;%&ndash;<li><a href="fixed.html"><i class="fa fa-circle-o"></i> 固定布局</a></li>&ndash;%&gt;--%>
<%--</ul>--%>
<%--</li>--%>
...
<%--&lt;%&ndash;<li class="active">Advanced Elements</li>&ndash;%&gt;--%>
<%--&lt;%&ndash;</ol>&ndash;%&gt;--%>
<%--</section>--%>
...
<%--&lt;%&ndash;<option>三级分类</option>&ndash;%&gt;--%>
...
<%--<label>一级分类</label>--%>
<%--<c:if test="${!empty category_success}">--%>
<%--<input class="form-control" disabled value="${category_success}">--%>
<%--</c:if>--%>
<%--<c:if test="${(empty category_success && empty category_error) || (!empty category_error)}">--%>
<%--<input class="form-control" name="category">--%>
<%--</c:if>--%>
<%--<H1> </H1>--%>
<%--<c:if test="${empty category_success && empty category_error}">--%>
...
<%--</span>--%>
<%--</c:if>--%>
<%--<c:if test="${!empty category_error}">--%>
...
<%--<div class="col-md-4">--%>
<%--<form action="/add_sort_3" method="post">--%>
<%--<div class="form-group">--%>
<%--<label>三级分类</label>--%>
...
<%--window.location = "/sort_second/"+xmlhttp.responseText;--%>
<%--}--%>
<%--}--%>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                三级分类
                <small> <a href="/add_sort_2/${category.c_id}"><b>${category.c_name}</b></a>/ ${category_second.cs_name}</small>
            </h1>
        </section>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="box box-default collapsed-box">
                        <div class="box-header with-border">
                            <h3 class="box-title">添加三级分类</h3>
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i>
                                </button>
                            </div>
                        </div>
                        <form action="/post_sort_3" method="post">
                            <div class="box-body">
                                <input class="form-control" name="category_third">
                                <input class="hidden" name="category_second_id" value="${category_second_id}">
                                <input class="hidden" name="category_id" value="${category_id}">
                                <p> </p>
                                <button type="submit" class="btn btn-block btn-flat btn-md btn-facebook">添加</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <!-- /.col -->
                <c:forEach var="category_third" items="${category_thirds}" step="1">
                        ...
                        <div class="info-box">
                            ...
                            <a href="#">
                                <div class="info-box-content">
                                    <span class="info-box-number">${category_third.ct_name}</span>
                                    <span class="info-box-text">一级分类</span>
                                </div>
                            </a>

                            <c:set var="ct_id" value="${category_third.ct_id}"/>
                            <c:set var="cs_id" value="${category_second.cs_id}"/>
                            <c:set var="c_id" value="${category_id}"/>
                            <!-- Modal -->
                            <div class="modal fade" id="${ct_id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog modal-danger" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="/delete_category_third" method="post">
                                                <input name="category_third_id" class="hidden" value="${ct_id}">
                                                <input name="category_second_id" class="hidden" value="${cs_id}">
                            ...
                            <button data-toggle="modal" data-target="#${ct_id}" class="btn btn-flat btn-block btn-danger fa fa-trash-o"> 删除</button>
