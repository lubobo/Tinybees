...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form action="/post_update_product" method="post" enctype="multipart/form-data">
                    <div class="col-md-3">
                                    ...
                                    <li>
                                        <div class="form-group">
                                            <div class="btn btn-default btn-file btn-block">
                                                ...
                                                <input id="imageInput1" onclick="changeImage1()" type="file" value="${product.image}" name="p_image">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <div  class="btn btn-default btn-file btn-block">
                                                ...
                                                <input id="imageInput2" onclick="changeImage2()" type="file" value="${product.image1}" name="p_image1">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <div class="btn btn-default btn-file btn-block">
                                                ...
                                                <input id="imageInput3" onclick="changeImage3()" type="file" value="${product.image2}" name="p_image2">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-group">
                                            <div class="btn btn-default btn-file btn-block">
                                                ...
                                                <input id="imageInput4" onclick="changeImage4()" type="file" value="${product.image3}" name="p_image3">
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="col-md-9">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <textarea id="compose-textarea" placeholder="${product.pdesc}" name="p_desc" class="form-control" style="height: 300px">
                                    </textarea>
                                </div>

                                <div class="form-group col-lg-2">
                                    <input class="form-control" name="p_market" value="${product.market_price}">
                                </div>

                                <div class="form-group col-lg-2">
                                    <input class="form-control" name="p_current" value="${product.current_price}">
                                </div>


                                <div class="form-group col-lg-2">
                                    <input class="form-control" name="p_color" value="${product.color}">
                                </div>
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    <input class="hidden" name="product_id" value="${product.p_id}">
    ...
    function getCategory_third(str,str1) {
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                window.location = "/update_third/"+xmlhttp.getResponseHeader("categories")+"/"+xmlhttp.getResponseHeader("categories_second");
            }
        }
