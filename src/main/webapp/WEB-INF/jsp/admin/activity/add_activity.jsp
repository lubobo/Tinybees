    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <!-- /.col -->
                <div class="col-md-12">
                    <form action="/post_activity" method="post">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="a_name" placeholder="活动名称:">
                                </div>
                                <div class="form-group">
                                <textarea id="compose-textarea" placeholder="活动简介" name="a_reward" class="form-control" style="height: 280px">
                                </textarea>
                                </div>

                                <div class="form-group col-lg-6">
                                    <input class="form-control" name="start_time" placeholder="开始时间" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>

                                <div class="form-group col-lg-6">
                                    <input class="form-control" name="end_time" placeholder="结束时间" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>
