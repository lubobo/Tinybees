                ...
                <div id="content" class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <c:forEach items="${wishpro}" var="wishpro">
                                <c:set var="pid" value="${wishpro.p_id}"/>
                            <tr id="${pid*99}">
                                <td class="text-center"><a href="/product?proid=${wishpro.p_id}"><img src="/image/product/samsung_tab_1-50x50.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" /></a></td>
                                <td class="text-left"><a href="/product?proid=${wishpro.p_id}">${wishpro.p_name}</a></td>
                                <td class="text-left">${wishpro.size}</td>
                                <td class="text-right"><div class="price"> ${wishpro.market_price}</div></td>
                                <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="/product?proid=${wishpro.p_id}" type="button" data-original-title="添加到购物车"><i class="fa fa-shopping-cart"></i></a>
                                    <form id="${pid}">
