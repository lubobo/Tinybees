...
<%--&lt;%&ndash;<option>一级分类</option>&ndash;%&gt;--%>
...
<%--!empty categorySecond_success||--%>
<%--!empty categorySecond_error||--%>
<%--!empty categoryThird_success||--%>
<%--!empty categoryThird_error}">--%>
<%--<input class="form-control" disabled value="${category_success}">--%>
<%--</c:if>--%>
<%--<c:if test="${(empty category_success && empty category_error) ||--%>
<%--(empty categorySecond_error&&empty categorySecond_success) ||--%>
<%--(empty categoryThird_error&&empty categoryThird_success)}">--%>
...
<%--</c:if>--%>
<%--<H1> </H1>--%>
<%--&lt;%&ndash;<c:if test="${empty category_success && empty category_error}">&ndash;%&gt;--%>
<%--&lt;%&ndash;<button class="col-md-4 btn btn-block btn-primary btn-flat" type="submit">&ndash;%&gt;--%>
<%--&lt;%&ndash;<span class="fa fa-edit">  添加</span>&ndash;%&gt;--%>
<%--&lt;%&ndash;</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
<%--<c:if test="${!empty category_success}">--%>
...
<%--</c:if>--%>
<%--<H1> </H1>--%>
<%--&lt;%&ndash;<c:if test="${empty categorySecond_success && empty categorySecond_error}">&ndash;%&gt;--%>
<%--&lt;%&ndash;<button class="col-md-4 btn btn-block btn-primary btn-flat" type="submit">&ndash;%&gt;--%>
<%--&lt;%&ndash;<span class="fa fa-edit">  添加</span>&ndash;%&gt;--%>
<%--&lt;%&ndash;</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
...
<%--<div class="form-group">--%>
<%--<label>三级分类</label>--%>
<%--<c:if test="${!empty categoryThird_success||--%>
<%--!empty categoryThird_error}">--%>
<%--<input class="form-control" disabled value="${categorySecond_success}">--%>
<%--</c:if>--%>
                ...
                <c:forEach var="category" items="${categories}" step="1">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <button data-toggle="modal" data-target="#${c_id}" class="btn btn-flat btn-block btn-danger fa fa-trash-o"> 删除</button>
