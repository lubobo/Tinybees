                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="box box-warning">
                                                            <div class="box-body box-profile box-warning">
                                                                <img class="profile-user-img img-responsive img-circle" src="/AdminLTE-cn/dist/img/user4-128x128.jpg" alt="User profile picture">

                                                                <h3 class="profile-username text-muted text-center">${o_name}</h3>

                                                                <p class="text-muted text-center">用户订单</p>

                                                                <ul class="list-group text-muted list-group-unbordered">
                                                                    <li class="list-group-item">
                                                                        <b>总价</b> <a class="pull-right">${order.total}</a>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        <b>下单时间</b> <a class="pull-right">${order.ordertime}</a>
                                                                    </li>
                                                                    <li class="list-group-item">
                                                        ...
                                                        <div class="box box-warning">
                                                            ...
                                                            <div class="text-muted box-body">
                                                                ...
                                                                <strong><i class="fa fa-envelope-o margin-r-5"></i> 时间</strong>
                                                                ...
                                                                <p class="text-muted">${order.addr}</p>

                                                                <hr>

                                                                <%--<strong><i class="fa fa-truck margin-r-5"></i> </strong>--%>

                                                                <%--<p class="text-muted">${order.state}</p>--%>
